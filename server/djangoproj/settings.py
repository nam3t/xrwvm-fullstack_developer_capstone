...
ALLOWED_HOSTS = ['localhost', 'https://namnh25-8000.theianext-1-labs-prod-misc-tools-us-east-0.proxy.cognitiveclass.ai']
CSRF_TRUSTED_ORIGINS = ['https://namnh25-8000.theianext-1-labs-prod-misc-tools-us-east-0.proxy.cognitiveclass.ai']
